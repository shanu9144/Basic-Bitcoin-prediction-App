...
model = load_model(r'C:\Users\sharm\OneDrive\Desktop\Bitcoin\Bitcoin_Price_prediction_Model.keras')

st.header('Bitcoin Price Prediction Model')
st.subheader('Bitcoin Price Data')
data = pd.DataFrame(yf.download('BTC-USD','2015-01-01','2024-01-31'))
